     ...
     var bitMask = 4;
      ...
      <ViroAmbientLight color="#ffffff" />
        ...
        <Viro3DObject
          ...
          resources={[
            require('./res/piecesmodels/jeans5tex.mtl'),
            require('./res/piecesmodels/jeans5paied.jpg'),
            require('./res/piecesmodels/jeans7tex.mtl'),
            require('./res/piecesmodels/jeans7paied.jpg'),
            require('./res/piecesmodels/jeans9tex.mtl'),
            require('./res/piecesmodels/jeans9paied.jpg'),
            require('./res/piecesmodels/jeans10tex.mtl'),
            require('./res/piecesmodels/jeans10paied.jpg'),
            require('./res/piecesmodels/logostdtex.mtl'),
          ]}
